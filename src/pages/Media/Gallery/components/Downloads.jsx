  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='flex flex-wrap gap-[30px] mt-[50px]'>
        <div className='w-full lg:w-[605px] lg:h-[64px] py-5 px-5 lg:px-[40px] flex items-center justify-between border-[8px] bg-[#2E2E2E] border-y-0 border-x-[#00AA55] rounded-lg'>
