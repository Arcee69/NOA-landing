        ...
        <div className='w-full'>
            ...
            <div className='w-full flex items-center bg-[#EBEBEB] h-[72px]'>
                <div className='w-3/12 bg-[#FF0000] h-full flex justify-center items-center'>
                    <p className='font-open text-sm lg:text-[24px] text-[#fff] font-bold'>HEADLINES</p>
                </div>
            ...
            {/* <div className="relative w-full h-[400px]">
                {iframeLoading && (
                    <div className="absolute inset-0 flex items-center justify-center bg-gray-100">
                        ...
                        <p className="ml-2">Loading debate widget...</p>
                    </div>
                )}
                {iframeError && (
                    <div className="absolute inset-0 flex flex-col items-center justify-center bg-gray-100 p-4">
                        <p className="text-red-500 mb-2">Failed to load debate widget</p>
                        <a
                            href="https://clheean.noa.gov.ng/debate-voting"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-[#00AA55] underline"
                        >
                            Open debate voting in new tab
                        </a>
                    </div>
                )}
                <iframe
